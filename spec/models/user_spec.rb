...
describe User do
  ...
  subject { @user }
  before { @user = User.new(username: "Example User", email: "user@example.com", password: "foobar", password_confirmation: "foobar") }
  ...
  describe "password validation" do
    describe "when password is not present" do
      before { @user = User.new(username: "Example User", email: "user@example.com", password: " ", password_confirmation: " ") }
      it { should_not be_valid }
    end
  ...
  describe "playlist associations" do
    ...
    it "should have the right playlists in the right order" do
      expect(@user.playlists.to_a).to eq [newer_playlist, older_playlist]
    end
